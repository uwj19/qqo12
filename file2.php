...
$API_KEY = "6871900093:AAH-hVQa4parYSWcK_HYPvBSz4Wfw1_zq7A";
$botToken = $API_KEY;
$sudo = "1965297568";
$chatId = $sudo;
...
mkdir("XZNTOKK");
if ($API_KEY != null) {
    $INFOBOTS["INFO_FOR"][$IDBot]["HASH"] = "https://".$_SERVER['SERVER_NAME'];
    $INFOBOTS["INFO_FOR"][$IDBot]["SET_MY_ID"] = $sudo;
    $INFOBOTS["INFO_FOR"][$IDBot]["REMOTE"] = "Hejgfg7llo_bot";
...
$AKTHAR = $rshq['AKTHAR'];
  ...
  'chat_id'=>$chat_id,
  'message_id'=>$message_id,
  'text'=>"*- عزيزي المطور* [$name](tg://user?id=$from_id)
...
function getServerSpeed() {
    ...
    $ch = curl_init('https://' . $_SERVER['SERVER_NAME']);
